...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~LiYRySAK#tC0zQvJ9hA90cB_MFL1uwkqWzosKq6QpD6Q-kRHM1qg", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "2349019113985", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS || "true",
AUTO_LIKE_STATUS: process.env.AUTO_LIKE_STATUS || "true",
AUTO_LIKE_EMOJI: process.env.AUTO_LIKE_EMOJI || "❤️", //Input Yours custom...
AUTO_REPLY_STATUS: process.env.AUTO_REPLY_STATUS || "false",
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || " Status Viewed by Grim!", // // Input Yours custom...
MODE: process.env.MODE || "private", // Put private or public or inbox or groups
OWNER_NUMBER: process.env.OWNER_NUMBER || "2349019113985", // Only 1 owner Number Here, others Add to sudo numbers...
...
AUTO_BIO_QUOTE: process.env.AUTO_BIO_QUOTE || "false",
